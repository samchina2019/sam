...
- (void)layoutSubviews
{
    ...
    _lastImgView.frame = CGRectMake(10, 0, CGRectGetWidth(self.scrollView.bounds)-20, CGRectGetHeight(self.scrollView.bounds));
    
    _currentImgView.frame = _isHorizontal?CGRectOffset(_lastImgView.frame, CGRectGetWidth(self.scrollView.bounds), 0):CGRectOffset(_lastImgView.frame, 0, CGRectGetHeight(_lastImgView.bounds));
        
    _nextImgView.frame = _isHorizontal?CGRectOffset(_currentImgView.frame, CGRectGetWidth(self.scrollView.bounds), 0):CGRectOffset(_currentImgView.frame, 0, CGRectGetHeight(_currentImgView.bounds));
    
    _lastImgView.layer.cornerRadius = 10;
    _lastImgView.layer.masksToBounds = YES;
    
    _currentImgView.layer.cornerRadius = 10;
    _currentImgView.layer.masksToBounds = YES;
    
    _nextImgView.layer.cornerRadius = 10;
    _nextImgView.layer.masksToBounds = YES;
    
    _currentLabel.frame = CGRectMake(10, 0, CGRectGetWidth(self.bounds)-20, CGRectGetHeight(self.bounds));
