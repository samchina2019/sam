//
//  GoodsFocusListViewController.m
//  SanMuZhuangXiu
//
...
@interface GoodsFocusListViewController ()
...
@implementation GoodsFocusListViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.
    self.navigationItem.title = @"商品关注";
    self.type=@"10";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.imgView sd_setImageWithURL:[NSURL URLWithString:model.img] placeholderImage:[UIImage imageNamed:@"defaultImg"]];
